...
![united-nations-lgbtqi-staff-rights-wireframe.png](insert url)
...
### Sensemaker
While not open source, the company [Sensemaker](https://sensemaker.cognitive-edge.com/product-category/sensemakerapplications/) has developed qualitative data collection methods that might be relevant. Sensemaker collects stories in snippets, and allows people to analyze their own contributions using a predefined set of tools. This allows the company to quickly derive signals based on cognitive frameworks. 
